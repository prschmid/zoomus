...
class UserComponentV2(base.BaseComponent):
    ...
    def update_email(self, **kwargs):
        ...
        the email to be updated must match one of the managed domains.
...
class UserComponentV3(base.BaseComponent):
    def me(self):
        return self.get_request("/users/me")
    ...
    def upload_picture(self, **kwargs):
        util.require_keys(kwargs, ["id", "files"])
        return self.post_request(
            "/users/{}/picture".format(kwargs.get("id")), files=kwargs
        )

    def remove_picture(self, **kwargs):
        util.require_keys(kwargs, "id")
        return self.delete_request(
            "/users/{}/picture".format(kwargs.get("id"))
        )
